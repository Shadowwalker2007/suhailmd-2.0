...
global.caption = process.env.CAPTION || global.caption || "© MANDISHONA INNOCENT" 
...
module.exports = {
  ...
  author : process.env.PACK_AUTHER|| "SHADOWWALKER",
  packname: process.env.PACK_NAME || "",
  botname : process.env.BOT_NAME  || "NOVA",
  ownername:process.env.OWNER_NAME|| "SHADOWWALKER",
